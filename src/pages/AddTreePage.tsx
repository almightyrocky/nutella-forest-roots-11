        ...
        <div className="max-w-md mx-auto">
          <Card>
            <CardHeader className="text-center">
              <div className="mx-auto bg-forest rounded-full p-4 mb-4 w-16 h-16 flex items-center justify-center">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Puoi trovare il codice all'interno della confezione del vasetto di Nutella Anniversary.
                  </p>
                </div>
              ...
              <div className="mt-8 border-t pt-4">
                ...
                <ol className="list-decimal pl-4 space-y-2 text-sm text-muted-foreground">
                  <li>Acquista un vasetto di Nutella Anniversary Edition</li>
          ...
          <div className="mt-6 text-center">
            <Button variant="ghost" onClick={() => navigate("/dashboard")} className="text-forest">
